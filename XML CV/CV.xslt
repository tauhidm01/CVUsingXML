				...
				<div id="container">
					<div id="me">
						...
						<ul id="contactdetails">
							<li>
								Address: <xsl:value-of select="//cv/me/@address"/>
							</li>
							<li>
								Telephone: <xsl:value-of select="//cv/me/@telephone"/>
							</li>
							<li>
								Email: <xsl:value-of select="//cv/me/@email"/>
							</li>
						</ul>
					</div>
					<div id="content">
	...
	<xsl:template name="showEmployment">
		<xsl:for-each select="//cv//employment/experience">
			<h3 class="jobtitle">
				...
				</strong>, <xsl:value-of select="@establishment"/>
				<span>
					<xsl:call-template name="showDateRange">
						<xsl:with-param name="fromDate" select="@from"/>
						<xsl:with-param name="toDate" select="@to"/>
